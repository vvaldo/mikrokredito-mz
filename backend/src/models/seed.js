...
async function seedNotificationDefaults() {
  // Templates e regras de notificação por omissão (email/SMS/WhatsApp).
  // Não são "dados de demonstração" — são configuração base do sistema,
  // por isso também são criados no modo --minimal do clean.js.
  const templates = [
