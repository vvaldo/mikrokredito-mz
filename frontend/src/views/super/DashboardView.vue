<template>
  <div class="modern-page">
    <section class="modern-hero">
      ...
      <p>Visão global padronizada e responsiva com números reais da base de dados.</p>
    ...
    <template v-else>
      ...
      <div class="modern-grid-2">
        <div class="modern-card">
          <div class="card-title">Pedidos recentes <button class="btn btn-sm" @click="router.push('/super/applications')">Ver todos</button></div>
...
function goNewRequest(){router.push('/super/applications')} function openLoan(l){selected.value=l; modal.value='loan'; modalTitle.value='Pedido '+l.reference} function viewNotif(n){selected.value=n; modal.value='notif'; modalTitle.value='Log de notificação'}
