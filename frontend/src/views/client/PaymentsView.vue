<template>
  <div class="modern-page">
    <section class="modern-hero">
      ...
      <p>Histórico de pagamentos e prestações pendentes.</p>
    ...
    <div class="kpi-grid">
      <div class="kpi good"><div class="label">Pagamentos</div><div class="value">{{ rows.length }}</div><div class="note">+12% este mês</div></div>
    ...
    <div class="modern-card">
      <h2>Pagamentos recentes</h2><p class="muted">Botões de visualizar, editar, aprovar, ver status e documentos activados com feedback.</p>
